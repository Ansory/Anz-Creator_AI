...
### 6. `core/story_teller.py`
**Perbaikan:** Menghapus *Circular Import* berbahaya (`server.py`), menambahkan proteksi *timeout* yang solid saat mengunduh aset, dan meng-*escape* karakter khusus dengan metode filter kompleks yang aman bagi Windows.
